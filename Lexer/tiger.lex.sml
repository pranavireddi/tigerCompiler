        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction56(strm, yyNO_MATCH)
                      else yyQ75(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction56(strm, yyNO_MATCH)
                  else yyQ75(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction56(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ75(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
              else yyAction56(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction56(strm, yyNO_MATCH)
                  else yyQ113(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ75(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
              else yyAction56(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ112(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction56(strm, yyNO_MATCH)
                  else yyQ75(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction56(strm, yyNO_MATCH)
                  else yyQ117(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ75(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
              else yyAction56(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ116(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction56(strm, yyNO_MATCH)
                  else yyQ75(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
...
fun yyQ56 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction37(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ119(strm', yyMATCH(strm, yyAction37, yyNO_MATCH))
       ...
       of NONE => yyAction39(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              ...
              then if inp = #"="
                  then yyQ120(strm', yyMATCH(strm, yyAction39, yyNO_MATCH))
...
fun yyQ52 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction52(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ122(strm', yyMATCH(strm, yyAction52, yyNO_MATCH))
...
fun yyQ123 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction55(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ123(strm', yyMATCH(strm, yyAction55, yyNO_MATCH))
            else if inp < #"0"
       ...
       of NONE => yyAction14(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"\""
              ...
              then if inp = #"\n"
                  then yyAction14(strm, yyNO_MATCH)
                  else yyQ3(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
            else if inp = #"\\"
              then yyAction14(strm, yyNO_MATCH)
              else yyQ3(strm', yyMATCH(strm, yyAction14, yyNO_MATCH))
      (* end case *))
