...
fun yyAction2 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentNestingDepth := 1; YYBEGIN COMMENTS; continue()))
fun yyAction3 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentNestingDepth := !commentNestingDepth + 1; continue()))
fun yyAction4 (strm, lastMatch : yymatch) = (yystrm := strm;
      (commentNestingDepth := !commentNestingDepth - 1; if !commentNestingDepth = 0 then (YYBEGIN INITIAL; continue()) else continue()))
fun yyAction5 (strm, lastMatch : yymatch) = (yystrm := strm; (continue()))
fun yyAction6 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringBuf := ""; stringStartPos := yypos; inString := true; YYBEGIN STRING; continue()))
fun yyAction7 (strm, lastMatch : yymatch) = (yystrm := strm;
      (inString := false; YYBEGIN INITIAL; Tokens.STRING(!stringBuf, !stringStartPos, yypos+1)))
...
fun yyAction12 (strm, lastMatch : yymatch) = (yystrm := strm;
      (stringBuf := !stringBuf ^ "\r"; continue()))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction60(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction20(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction20(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction20, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ85(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction19(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction19(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction19, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction29(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction29(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ80(strm', yyMATCH(strm, yyAction29, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction33(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction33(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction33, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction23(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction23(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction23, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction26(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction26(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ80(strm', yyMATCH(strm, yyAction26, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction27(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction27(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction27, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction25(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction25(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction25, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction34(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction34(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction34, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction21(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction21(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction21, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction24(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction24(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction24, yyNO_MATCH))
            else if inp = #"`"
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction32(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction32(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
            else if inp = #"`"
              ...
              then if inp = #"_"
                  then yyQ80(strm', yyMATCH(strm, yyAction32, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction28(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction28(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction28, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ115(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"o"
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction22(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction22(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction22, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ118(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ117(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"e"
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction35(strm, yyNO_MATCH)
                      else yyQ80(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction35(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction35, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ123(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"y"
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ122(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ121(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then yyQ120(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp < #"r"
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ80(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
...
fun yyQ59 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction43(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #">"
              then yyQ126(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
            else if inp < #">"
              then if inp = #"="
                  then yyQ125(strm', yyMATCH(strm, yyAction43, yyNO_MATCH))
...
fun yyQ57 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction56(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"="
              then yyQ127(strm', yyMATCH(strm, yyAction56, yyNO_MATCH))
...
fun yyQ128 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction59(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"0"
              then yyQ128(strm', yyMATCH(strm, yyAction59, yyNO_MATCH))
            else if inp < #"0"
...
fun yyQ55 (strm, lastMatch : yymatch) = (case (yygetc(strm))
       of NONE => yyAction45(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"*"
              then yyQ129(strm', yyMATCH(strm, yyAction45, yyNO_MATCH))
...
in
  (case (!(yyss))
   of COMMENTS => yyQ0(!(yystrm), yyNO_MATCH)
