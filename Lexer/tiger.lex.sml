        ...
        | SOME(inp, strm') =>
            if inp = #"["
              ...
              then if inp = #":"
                  ...
                  then if inp <= #"/"
                      then yyAction60(strm, yyNO_MATCH)
                      else yyQ65(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
                else if inp <= #"@"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ65(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp = #"`"
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ70(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
       ...
       of NONE => yyAction60(strm, yyNO_MATCH)
        | SOME(inp, strm') =>
            if inp = #"_"
              ...
              then if inp = #"`"
                  then yyAction60(strm, yyNO_MATCH)
                  else yyQ103(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
            else if inp <= #"z"
              then yyQ65(strm', yyMATCH(strm, yyAction60, yyNO_MATCH))
              else yyAction60(strm, yyNO_MATCH)
      (* end case *))
